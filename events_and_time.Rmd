...
plot_2 = 
  ...
  summarise(event_num = n()) %>% 
  plot_ly(
    x = ~quarter, y = ~event_num, type = "scatter"
  )

layout(plot_2, title = "Crime events over seasons", xaxis = list(title = "Quarter"), yaxis = list(title = "Number of Crime Events"))
```
...
layout(plot_4, title = "Crime events over weeks", xaxis = list(title = "Week"), yaxis = list(title = "Number of Crime Events"))
```
