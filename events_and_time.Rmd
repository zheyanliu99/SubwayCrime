...
The overall trend of quantity of events was increasing, and the overall quantity of events after the fourth quarter of 2013 is higher than that before the fourth quater of 2013.
...
layout(plot_3, title = "Crime events over month", xaxis = list(title = "Month"), yaxis = list(title = "Number of Crime Events (K)"))
...
plot_4 = 
  ...
  summarise(event_num = n() / 1000) %>% 
  plot_ly(
    x = ~month, y = ~event_num, type = "scatter", mode = "points"
  )

layout(plot_4, title = "Crime events over month", xaxis = list(title = "Month"), yaxis = list(title = "Number of Crime Events (K)"))
