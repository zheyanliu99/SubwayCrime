...
raw_sub_crime = 
  ...
  mutate(
    event_time =
      case_when(
      hms("00:00:00") <= start_time & start_time <= hms("00:59:00") ~ hms("00:00:00"),
      hms("01:00:00") <= start_time & start_time <= hms("01:59:00") ~ hms("01:00:00"),
      hms("02:00:00") <= start_time & start_time <= hms("02:59:00") ~ hms("02:00:00"),
      hms("03:00:00") <= start_time & start_time <= hms("03:59:00") ~ hms("03:00:00"),
      hms("04:00:00") <= start_time & start_time <= hms("04:59:00") ~ hms("04:00:00"),
      hms("05:00:00") <= start_time & start_time <= hms("05:59:00") ~ hms("05:00:00"),
      hms("06:00:00") <= start_time & start_time <= hms("06:59:00") ~ hms("06:00:00"),
      hms("07:00:00") <= start_time & start_time <= hms("07:59:00") ~ hms("07:00:00"),
      hms("08:00:00") <= start_time & start_time <= hms("08:59:00") ~ hms("08:00:00"),
      hms("09:00:00") <= start_time & start_time <= hms("09:59:00") ~ hms("09:00:00"),
      hms("10:00:00") <= start_time & start_time <= hms("10:59:00") ~ hms("10:00:00"),
      hms("11:00:00") <= start_time & start_time <= hms("11:59:00") ~ hms("11:00:00"),
      hms("12:00:00") <= start_time & start_time <= hms("12:59:00") ~ hms("12:00:00"),
      hms("13:00:00") <= start_time & start_time <= hms("13:59:00") ~ hms("13:00:00"),
      hms("14:00:00") <= start_time & start_time <= hms("14:59:00") ~ hms("14:00:00"),
      hms("15:00:00") <= start_time & start_time <= hms("15:59:00") ~ hms("15:00:00"),
      hms("16:00:00") <= start_time & start_time <= hms("16:59:00") ~ hms("16:00:00"),
      hms("17:00:00") <= start_time & start_time <= hms("17:59:00") ~ hms("17:00:00"),
      hms("18:00:00") <= start_time & start_time <= hms("18:59:00") ~ hms("18:00:00"),
      hms("19:00:00") <= start_time & start_time <= hms("19:59:00") ~ hms("19:00:00"),
      hms("20:00:00") <= start_time & start_time <= hms("20:59:00") ~ hms("20:00:00"),
      hms("21:00:00") <= start_time & start_time <= hms("21:59:00") ~ hms("21:00:00"),
      hms("22:00:00") <= start_time & start_time <= hms("22:59:00") ~ hms("22:00:00"),
      hms("23:00:00") <= start_time & start_time <= hms("23:59:00") ~ hms("23:00:00")
      )
  ) %>% 
