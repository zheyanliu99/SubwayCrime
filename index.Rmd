...
### In this website, you can find:
  ...
  * Build a crime Dashboard about crime rate and crime events in different station and clusters
  * Analysis of [passengers flow](PassengerEDA.html) of subway and its relationship with the location; How we use Kmeans based on this analysis. 
...
* 1 Clean and imputed crime by location data;create a crime rate  shiny dashboard, build project website and participate in writing report
* 2 Conduct EDA on subway passenger data&location; Feature engineering on coordinates with K-means
* 3 Build subway navigation app based on Google Maps Apis and adapted GNN into crime prediction on each route
