...
* 1 Cleaned and imputed subway passenger data; Built project website and organized final report
* 2 Conduct EDA on subway passenger data&location; Feature engineering on coordinates with K-means
* 3 Built subway navigation app based on Google Maps Apis and adapted GNN into crime prediction on each route
